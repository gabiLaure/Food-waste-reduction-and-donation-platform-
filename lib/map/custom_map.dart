...
class CustomMap extends StatefulWidget {
  final List<Map<String, dynamic>> donations; // List containing donations info

  CustomMap({required this.donations});
