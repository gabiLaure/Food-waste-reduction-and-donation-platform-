...
class EditDonationPage extends StatefulWidget {
  final Map<String, dynamic> donationData; // Data passed to edit

  EditDonationPage({required this.donationData});
...
class _EditDonationPageState extends State<EditDonationPage> {
  ...
  String selectedCommunity = "All Community";
  String? location;
  String? foodImage;
  ...
  void initState() {
    super.initState();
    // Initialize with existing donation data
    foodTypeController.text = widget.donationData['foodType'];
    descriptionController.text = widget.donationData['description'];
    quantityController.text = widget.donationData['quantity'].toString();
    selectedCommunity = widget.donationData['community'];
    location = widget.donationData['location'];
    foodImage = widget.donationData['foodImage'];
  }
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: foodImage == null
                      ? Center(child: Text('Add food Image'))
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Enter Food Quantity (in Kg)',
                  border: OutlineInputBorder(),
                ),
              ),
              ...
              ElevatedButton(
                onPressed: () {
                  // Save edited data logic (e.g., update Firestore)
                  // Example:
                  // updateDonation(widget.donationData['id'], updatedData);
                },
